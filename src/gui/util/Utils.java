...
public class Utils {
	...
	public static Stage currentStage(ActionEvent event) { // retorna o stage atual (action Event é o qu o botão recebe)
		return (Stage) ((Node) event.getSource()).getScene().getWindow(); // Node é downcast do getSourse e o Stage é um
																			// downcast do getWindow
	}
	...
	public static <T> void formatTableColumnDate(TableColumn<T, Date> tableColumn, String format) { // formatar data  //profe não explicou Crtl+C Ctrl+V
	...
	public static <T> void formatTableColumnDouble(TableColumn<T, Double> tableColumn, int decimalPlaces) { // formatar double  //profe não explicou
		tableColumn.setCellFactory(column -> {
